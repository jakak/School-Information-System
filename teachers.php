        ...
        <div class="jumbotron">
            ...
            <?php 
                ...
                if($result->num_rows > 0){
                    echo '<table class="table"><tr><th>Surname Name</th><th>First Name</th><th>Middle Name</th><th>Date of Employment</th><th>Gender</th><th>Section</th><th>Department</th><th>Grade Level</th></tr>';
                    while($row = $result->fetch_assoc()) {
                        echo "<tr><td>" .$row["surname"]. "</td><td>" .$row["firstname"]. "</td><td>" .$row["midname"]. "</td><td>" .$row["doe"]. "</td><td>" .$row["gender"]. "</td><td>" .$row["section"]. "</td><td>" .$row["dept"]. "</td><td>" .$row["GL"]. "</td></tr>";
                    }
